            ...
            <div className="container mx-auto px-6 flex justify-between items-center">
                <Link to="/" className="flex items-center group">
                    <img
                        ...
                        alt="CalafateGo Logo"
                        className={`h-14 w-auto transition-all duration-500 group-hover:rotate-[20deg] group-hover:scale-110 drop-shadow-md ${!headerBg ? 'brightness-125 saturate-150 drop-shadow-[0_0_8px_rgba(255,255,255,0.4)]' : ''}`}
                    />
